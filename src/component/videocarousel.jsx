...
//         if (span[videoId]) {
//             //animate progress pf the video playing
...
//                             <div className="2-full h-full flex-center rounded-3xl bg-black overflow-hidden">
//                                 <video
//                                     ref={(event) => (videoRef.current[index] = event)}
//                                     onEnded={() =>
//                                         index !== 3
...
//                         <span key={i} ref={(e) => (videoDivRef.current[i] = e)} className="mx-2 w-3 h-3 bg-gray-200 rounded-full relative cursor-pointer">
//                             <span className="absolute h-full w-full rounded-full" ref={(e) => (videoSpanRef.current[i] = e)}></span>
//                         </span>
//                     ))}
//                 </div>
